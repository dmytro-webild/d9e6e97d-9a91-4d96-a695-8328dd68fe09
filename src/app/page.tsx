...
export default function LandingPage() {
      ...
      products={[
        {
          ...
          imageAlt: "A plate of Big Breakfast with eggs, bacon, toast, and pancakes",
        },
        {
          id: "rice-pudding",
          brand: "Dessert",
          ...
          rating: 5,
          reviewCount: "120+",
          imageSrc: "http://img.b2bpic.net/free-photo/traditional-turkish-sutlac-sutlach-cooked-served-with-cinnamon-sticks_114579-1838.jpg",
          imageAlt: "Bowl of creamy rice pudding with cinnamon",
        },
        {
          ...
          rating: 5,
          reviewCount: "180+",
          imageSrc: "http://img.b2bpic.net/free-photo/cookie-topped-with-banana-slices_141793-646.jpg",
          imageAlt: "Slice of lemon meringue pie with a tall, fluffy meringue",
        },
        {
          id: "cherry-pie",
          brand: "Dessert",
          ...
          rating: 5,
          reviewCount: "150+",
          imageSrc: "http://img.b2bpic.net/free-photo/cottagecore-food-inspiration-still-life_23-2150152985.jpg",
          imageAlt: "Slice of homemade cherry pie with lattice crust",
        },
        {
        ...
        },
        {
          ...
          brand: "Soup",
          name: "Hearty Stuffed Pepper Soup",
          price: "$5.50/bowl",
          rating: 5,
          reviewCount: "75+",
  ...
  <div id="specials" data-section="specials">
      ...
      positiveCard={{
        items: [
          "Big Breakfast (All Day)",
          "Creamy Rice Pudding",
          "Zesty Lemon Meringue Pie",
          "Comforting Chicken Noodle Soup",
          "Rich Stuffed Pepper Soup",
        ],
      }}
      ...
      testimonials={[
        {
          ...
          name: "Sarah P.",
          handle: "@sarah_eats",
          testimonial: "What's Cook'n is our go-to spot for breakfast! The Big Breakfast is incredible, and the staff always makes us feel right at home. It's truly a Youngstown gem!",
          rating: 5,
        ...
        },
        {
          ...
          name: "Mark D.",
          handle: "@mark_travels",
          testimonial: "Stopped by on a road trip and was blown away. The Lemon Meringue Pie was the best I've ever had. Such a warm, welcoming diner with genuine comfort food.",
          rating: 5,
        ...
        },
        {
          id: "3",
          name: "Jessica L.",
          handle: "@jessica_local",
          testimonial: "You haven't truly experienced Youngstown until you've had a meal at What's Cook'n. It's nostalgia on a plate, with flavors that remind you of grandma's cooking. Absolutely love it!",
          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-photo/portrait-young-adult-smiling-woman-wearing-white-clothing-looking-directly-camera-with-happy-expression-posing-green-meadow-sunset-sunrise_176532-14789.jpg",
          imageAlt: "Jessica L. customer photo",
        },
        {
          id: "4",
          name: "Robert K.",
          handle: "@robert_foodie",
          testimonial: "Every time I'm in town, I make sure to visit. The Chicken Noodle Soup is perfect, and the service is always top-notch. A true classic diner experience!",
          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-photo/positive-confident-girl-choosing-you_1262-17150.jpg",
          imageAlt: "Robert K. customer photo",
        },
      ]}
      showRating={true}
      ...
      faqs={[
        {
          ...
          content: "We are proudly located at 6007 South Ave, Youngstown, OH 44512, within Mathews Square.",
        },
        {
          id: "faq2",
          title: "Do you offer takeout?",
          content: "Yes, all our delicious menu items are available for takeout. Just give us a call during opening hours to place your order!",
        },
      ]}
  ...
  <div id="footer" data-section="footer">
      ...
      columns={[
        ...
        },
        {
          ...
          items: [
            {
              label: "Call: +1 330-726-1622",
              href: "tel:+13307261622",
            },
            {
              label: "Visit: 6007 South Ave",
              href: "#contact",
            },
          ],
        },
